# Document / Example Project / Test3 / SDFGHSDF / Image

## Project Overview

Kho ảnh của Item mẫu `SDFGHSDF`. Đây là dữ liệu đầu vào/đầu ra để kiểm thử ImageEditor và Droplet Analysis, không phải source code.

## Annotated Directory Structure

- File hiện có (2): `capture_20260219_110907.png`, `TNH_20260219_111234.png`.
