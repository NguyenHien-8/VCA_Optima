# Document / Example Project / Test3

## Project Overview

Project mẫu `Test3` theo schema filesystem của VCA Optima. `config.json` là marker để `ProjectManager` công nhận project.

## Annotated Directory Structure

- `adAEDd/` — thư mục con trong dataset mẫu.
- `DFGHDGH_Copy1/` — thư mục con trong dataset mẫu.
- `fghfghfgh/` — thư mục con trong dataset mẫu.
- `fhhfhdfd/` — thư mục con trong dataset mẫu.
- `hfhfh/` — thư mục con trong dataset mẫu.
