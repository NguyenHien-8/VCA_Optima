# Document / Example Project / Test3 / fhhfhdfd / Video

## Project Overview

Kho video của Item mẫu `fhhfhdfd`. Dữ liệu phục vụ kiểm thử playback/capture; thư mục có thể trống.

## Annotated Directory Structure

- File hiện có (1): `Hien.mp4`.
