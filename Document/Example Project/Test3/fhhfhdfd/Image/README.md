# Document / Example Project / Test3 / fhhfhdfd / Image

## Project Overview

Kho ảnh của Item mẫu `fhhfhdfd`. Đây là dữ liệu đầu vào/đầu ra để kiểm thử ImageEditor và Droplet Analysis, không phải source code.

## Annotated Directory Structure

- File hiện có (2): `Hau.png`, `Thanh.png`.
