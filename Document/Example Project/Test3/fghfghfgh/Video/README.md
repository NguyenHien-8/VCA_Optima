# Document / Example Project / Test3 / fghfghfgh / Video

## Project Overview

Kho video của Item mẫu `fghfghfgh`. Dữ liệu phục vụ kiểm thử playback/capture; thư mục có thể trống.

## Annotated Directory Structure

- File hiện có (1): `Test.mp4`.
