# Document / Example Project / Test3 / adAEDd / Image

## Project Overview

Kho ảnh của Item mẫu `adAEDd`. Đây là dữ liệu đầu vào/đầu ra để kiểm thử ImageEditor và Droplet Analysis, không phải source code.

## Annotated Directory Structure

- File hiện có (1): `capture_20260219_110145.png`.
