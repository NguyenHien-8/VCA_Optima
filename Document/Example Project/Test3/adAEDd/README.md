# Document / Example Project / Test3 / adAEDd

## Project Overview

Item mẫu `adAEDd` thuộc project `Test3`. Item là đơn vị lưu một phiên/chất lỏng với hai kho media bắt buộc.

## Annotated Directory Structure

- `Image/` — thư mục con chứa ảnh.
- `Video/` — thư mục con chứa video.
- File hiện có (1): `adAEDd.tnh`.
