# Document / Example Project / VatLieuB / ChatLong2 / Image

## Project Overview

Kho ảnh của Item mẫu `ChatLong2`. Đây là dữ liệu đầu vào/đầu ra để kiểm thử ImageEditor và Droplet Analysis, không phải source code.

## Annotated Directory Structure

- File hiện có (10): `Image1.png`, `Image2.png`, `Image3.png`, `Image4.png`, `Image5.png`, `Test1.png`, `Test2.png`, `Test3.png`, `Test4.png`, `Test5.png`.
