# Document / Example Project / Test4 / Demo5 / Image

## Project Overview

Kho ảnh của Item mẫu `Demo5`. Đây là dữ liệu đầu vào/đầu ra để kiểm thử ImageEditor và Droplet Analysis, không phải source code.

## Annotated Directory Structure

- File hiện có (1): `TNH_20260221_182916.png`.
