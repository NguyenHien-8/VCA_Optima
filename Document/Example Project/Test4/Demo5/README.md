# Document / Example Project / Test4 / Demo5

## Project Overview

Item mẫu `Demo5` thuộc project `Test4`. Item là đơn vị lưu một phiên/chất lỏng với hai kho media bắt buộc.

## Annotated Directory Structure

- `Image/` — thư mục con chứa ảnh.
- `Video/` — thư mục con chứa video.
- File hiện có (1): `Demo5.tnh`.
