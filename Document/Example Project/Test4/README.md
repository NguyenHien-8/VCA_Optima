# Document / Example Project / Test4

## Project Overview

Project mẫu `Test4` theo schema filesystem của VCA Optima. `config.json` là marker để `ProjectManager` công nhận project.

## Annotated Directory Structure

- `Demo1/` — thư mục con trong dataset mẫu.
- `Demo2/` — thư mục con trong dataset mẫu.
- `Demo3/` — thư mục con trong dataset mẫu.
- `Demo4/` — thư mục con trong dataset mẫu.
- `Demo5/` — thư mục con trong dataset mẫu.
