# Document / Example Project / Test4 / Demo4 / Image

## Project Overview

Kho ảnh của Item mẫu `Demo4`. Đây là dữ liệu đầu vào/đầu ra để kiểm thử ImageEditor và Droplet Analysis, không phải source code.
