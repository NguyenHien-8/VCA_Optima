# Document / Example Project / Test5 / Demo3 / Image

## Project Overview

Kho ảnh của Item mẫu `Demo3`. Đây là dữ liệu đầu vào/đầu ra để kiểm thử ImageEditor và Droplet Analysis, không phải source code.
