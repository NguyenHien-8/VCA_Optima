# Document / Example Project / VatLieuA / ChatLong2

## Project Overview

Item mẫu `ChatLong2` thuộc project `VatLieuA`. Item là đơn vị lưu một phiên/chất lỏng với hai kho media bắt buộc.
