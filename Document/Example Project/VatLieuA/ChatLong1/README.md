# Document / Example Project / VatLieuA / ChatLong1

## Project Overview

Item mẫu `ChatLong1` thuộc project `VatLieuA`. Item là đơn vị lưu một phiên/chất lỏng với hai kho media bắt buộc.
