# Document / Example Project / Test2 / HNJGDJHG / Image

## Project Overview

Kho ảnh của Item mẫu `HNJGDJHG`. Đây là dữ liệu đầu vào/đầu ra để kiểm thử ImageEditor và Droplet Analysis, không phải source code.
