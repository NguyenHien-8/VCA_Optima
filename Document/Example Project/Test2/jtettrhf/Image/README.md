# Document / Example Project / Test2 / jtettrhf / Image

## Project Overview

Kho ảnh của Item mẫu `jtettrhf`. Đây là dữ liệu đầu vào/đầu ra để kiểm thử ImageEditor và Droplet Analysis, không phải source code.
