# Document / Example Project / Test2 / dfndnnd / Video

## Project Overview

Kho video của Item mẫu `dfndnnd`. Dữ liệu phục vụ kiểm thử playback/capture; thư mục có thể trống.

## Annotated Directory Structure

- File hiện có (2): `shshs.mp4`, `video_20260228_095958.mp4`.
