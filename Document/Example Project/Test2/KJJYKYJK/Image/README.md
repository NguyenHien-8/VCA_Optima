# Document / Example Project / Test2 / KJJYKYJK / Image

## Project Overview

Kho ảnh của Item mẫu `KJJYKYJK`. Đây là dữ liệu đầu vào/đầu ra để kiểm thử ImageEditor và Droplet Analysis, không phải source code.

## Annotated Directory Structure

- File hiện có (3): `TNH_20260219_142039.png`, `TNH_20260219_145103.png`, `TNH_20260219_150311.png`.
