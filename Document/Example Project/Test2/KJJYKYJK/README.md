# Document / Example Project / Test2 / KJJYKYJK

## Project Overview

Item mẫu `KJJYKYJK` thuộc project `Test2`. Item là đơn vị lưu một phiên/chất lỏng với hai kho media bắt buộc.

## Annotated Directory Structure

- `Image/` — thư mục con chứa ảnh.
- `Video/` — thư mục con chứa video.
- File hiện có (1): `KJJYKYJK.tnh`.
