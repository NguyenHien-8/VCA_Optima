# Document / Example Project / Test2 / jyjyjty

## Project Overview

Item mẫu `jyjyjty` thuộc project `Test2`. Item là đơn vị lưu một phiên/chất lỏng với hai kho media bắt buộc.

## Annotated Directory Structure

- `Image/` — thư mục con chứa ảnh.
- `Video/` — thư mục con chứa video.
- File hiện có (1): `jyjyjty.tnh`.
