# Document / Example Project / Test2 / jyjyjty / Image

## Project Overview

Kho ảnh của Item mẫu `jyjyjty`. Đây là dữ liệu đầu vào/đầu ra để kiểm thử ImageEditor và Droplet Analysis, không phải source code.
