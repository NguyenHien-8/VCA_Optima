# Document / Example Project / Test2 / JRFJTJ / Image

## Project Overview

Kho ảnh của Item mẫu `JRFJTJ`. Đây là dữ liệu đầu vào/đầu ra để kiểm thử ImageEditor và Droplet Analysis, không phải source code.

## Annotated Directory Structure

- File hiện có (1): `Hien.jpg`.
