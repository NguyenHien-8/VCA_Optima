# Document / Example Project / Test2 / JTRJTRJ / Image

## Project Overview

Kho ảnh của Item mẫu `JTRJTRJ`. Đây là dữ liệu đầu vào/đầu ra để kiểm thử ImageEditor và Droplet Analysis, không phải source code.

## Annotated Directory Structure

- File hiện có (3): `capture_20260219_110743.png`, `Hien.jpg`, `TNH_20260219_145650.png`.
