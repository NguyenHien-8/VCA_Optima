...
9. ImageEditor mở Droplet Analysis → truyền source path + MainView owner → helper gán transient owner/taskbar style → grouped preview; close phát `destroyed` để gỡ khỏi danh sách cửa sổ.
