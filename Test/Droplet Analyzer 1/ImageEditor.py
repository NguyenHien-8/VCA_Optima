...
class CalibrationResultDialog(QDialog):
    ...
    def __init__(self, analysis_result, parent=None):
        ...
        self.setWindowTitle("Droplet Analysis Result")
    ...
    def setup_ui(self):
        ...
        ax1.set_title("Droplet Analysis", fontsize=15, fontweight='bold')
        ax1.axis('off')
        ...
        if self.analysis_result.success:
            ...
            info_text += self.analysis_result.get_formatted_results()
        else:
        ...
        if file_path:
            try:
                with open(file_path, 'w', encoding='utf-8') as f:
                    ...
                    if self.analysis_result.success:
                        # Sử dụng get_formatted_results để lấy dữ liệu
                        f.write(self.analysis_result.get_formatted_results())
                    else:
...
class ImageEditor(QWidget):
    ...
    def setup_ui(self):
        ...
        self.btn_calibration.setToolTip("Droplet Analysis")
    ...
    def on_capture_clicked(self):
        ...
        if self.current_pixmap is None or self.current_pixmap.isNull():
            QMessageBox.warning(self, "No Image", "No photos to take/save.")
            return
    ...
    def on_calibration_clicked(self):
        ...
        if self.current_pixmap is None or self.current_pixmap.isNull():
            QMessageBox.warning(self, "No Image", "Please load the image before calibration.")
            return
