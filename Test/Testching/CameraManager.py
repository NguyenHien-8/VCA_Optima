...
from Src.Services.CameraThread import CameraThread
from Src.Services.HardwareCameraScan import HardwareCameraScan
...
class CameraManager(QObject):
    ...
    # --- 1. Thêm tính năng Pause/Resume ---
    def set_paused(self, paused: bool):
        """Điều khiển tạm dừng camera hiện tại"""
